...
<execution_context>
@G:/ONGOING PROJECTS/Digital_product-auto_poster/.windsurf/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @G:/ONGOING PROJECTS/Digital_product-auto_poster/.windsurf/get-shit-done/workflows/add-tests.md end-to-end.
