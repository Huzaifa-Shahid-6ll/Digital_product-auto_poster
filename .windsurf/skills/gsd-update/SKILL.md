...
<execution_context>
@G:/ONGOING PROJECTS/Digital_product-auto_poster/.windsurf/get-shit-done/workflows/update.md
</execution_context>

<process>
**Follow the update workflow** from `@G:/ONGOING PROJECTS/Digital_product-auto_poster/.windsurf/get-shit-done/workflows/update.md`.
