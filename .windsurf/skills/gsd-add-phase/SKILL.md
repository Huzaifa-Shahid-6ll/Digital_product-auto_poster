...
<execution_context>
@G:/ONGOING PROJECTS/Digital_product-auto_poster/.windsurf/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@G:/ONGOING PROJECTS/Digital_product-auto_poster/.windsurf/get-shit-done/workflows/add-phase.md`.
