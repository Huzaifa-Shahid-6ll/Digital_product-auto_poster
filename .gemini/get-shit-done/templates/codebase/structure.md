...
- Usage: Reference from command with `@G:/ONGOING PROJECTS/Digital_product-auto_poster/.gemini/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to G:/ONGOING PROJECTS/Digital_product-auto_poster/.gemini/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to G:/ONGOING PROJECTS/Digital_product-auto_poster/.gemini/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
