...
Use template from `G:/ONGOING PROJECTS/Digital_product-auto_poster/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `G:/ONGOING PROJECTS/Digital_product-auto_poster/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "G:/ONGOING PROJECTS/Digital_product-auto_poster/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
