...
<execution_context>
@G:/ONGOING PROJECTS/Digital_product-auto_poster/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @G:/ONGOING PROJECTS/Digital_product-auto_poster/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
