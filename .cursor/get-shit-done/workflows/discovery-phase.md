...
See G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/templates/discovery.md
...
Use G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/templates/discovery.md.
