...
- **Global scope**: `G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/notes/`)
...
2. Glob `G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/notes/` — works in any directory
