...
<!-- For checkpoint task examples and patterns, see @G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/references/checkpoints.md -->
...
See `G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `G:/ONGOING PROJECTS/Digital_product-auto_poster/.cursor/get-shit-done/workflows/verify-phase.md` for verification logic.
